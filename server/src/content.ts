...
export const rules: Rule[] = [
  ...
  { id: "rule-002", title: "不要直視主管門", text: "經過 Executive Office 時不可停留在門前。", category: "area", difficulty: 2 },
  { id: "rule-003", title: "紅燈靜音", text: "紅燈事件發生時，5 秒內不要傳送聊天訊息。", category: "event", difficulty: 3 },
  { id: "rule-004", title: "會議不回頭", text: "Meeting Room 內移動時不可連續往反方向走。", category: "meeting", difficulty: 2 },
  { id: "rule-005", title: "檔案室禁跑", text: "進入 Archive 後 15 秒內不可使用衝刺或快速移動。", category: "area", difficulty: 3 },
  { id: "rule-006", title: "最後工時", text: "final_work 階段不可開始新任務。", category: "phase", difficulty: 2 },
  { id: "rule-007", title: "主管監聽", text: "Executive Office 附近聊天會暴露自己的規則。", category: "chat", difficulty: 4 },
  ...
  { id: "rule-010", title: "咖啡禁令", text: "Break Room 發生靈異事件時不可完成任務。", category: "event", difficulty: 3 },
  ...
  { id: "rule-014", title: "封鎖門禁", text: "被鎖門干擾後 10 秒內不可進入 Exit Gate。", category: "sabotage", difficulty: 4 },
  { id: "rule-015", title: "假任務陷阱", text: "看見不在任務清單的工作項目時不可開始。", category: "sabotage", difficulty: 3 },
  { id: "rule-016", title: "逃生順序", text: "escape 階段必須先到 Reception 再前往 Exit Gate。", category: "escape", difficulty: 2 },
  ...
  { id: "rule-020", title: "主管巡視", text: "主管巡視時不可進入 Executive Office。", category: "sabotage", difficulty: 3 }
];
...
export const tasks: TaskDef[] = [
  {
    ...
    steps: ["前往 Archive", "確認檔案標籤", "依紅、黑、白三類歸檔", "送出歸檔紀錄"],
  ...
  },
  {
    ...
    steps: ["前往 Accounting", "核對帳本頁碼", "比對收據金額", "確認主管簽章"],
    risk: "Accounting 內完成任務後要留意私人規則與聊天限制。"
  },
  {
    id: "task-server",
    name: "重啟伺服器",
    ...
    steps: ["前往 Server Room", "關閉異常程序", "等待藍燈穩定", "重新啟動主機"],
  ...
  },
  {
    ...
    steps: ["前往 Reception", "記住文件排序", "啟動影印機", "交回封存文件"],
    risk: "印表機靈異事件會讓 Reception 任務變慢。"
  },
  {
    id: "task-coffee",
    name: "沖泡主管咖啡",
    ...
    steps: ["前往 Break Room", "選擇黑咖啡粉", "等待溫度落在安全區間", "放到指定托盤"],
    risk: "Break Room 有事件時可能不允許完成任務。"
  },
  {
    id: "task-minutes",
    name: "補交會議紀錄",
    ...
    steps: ["前往 Meeting Room", "整理錄音片段", "補上缺漏發言", "提交會議紀錄"],
    risk: "Meeting Room 停留過久可能違反私人規則。"
  }
];
...
export const spiritualEvents: SpiritualEvent[] = [
  ...
  { id: "printer-laugh", name: "印表機笑聲", description: "Reception 和 Archive 任務變慢。", duration: 22, effectType: "printer_noise" },
  ...
  { id: "exit-whisper", name: "出口低語", description: "Exit Gate 會顯示不可靠的提示。", duration: 20, effectType: "exit_hint" }
];
